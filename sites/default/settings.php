 ...
 * @endcode
 */
$settings['hash_salt'] = 'j0DEGCH150PKxdC4ZEuTHypOAK3RrTpERhP82JtaQ7SgGAZ1vIik6OgqPDWCLXYB4PmSDCLNow';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_BTV_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_BTV_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'btv',
...
$config_directories['sync'] = 'sites/btv.dd/files/config_HXjvvmCnBkQjF0Yf_D3Bk85vMNzS5rqwxaU-VHWFApYN5hfaioJoP4MQcY9DVpfiRD4kkGw2gg/sync';
